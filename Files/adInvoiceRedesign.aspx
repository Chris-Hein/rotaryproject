...
<script runat="server">
    ...
    string processedInvoiceAddresses;
    string messageAddresses;
    string processedMessageAddresses;
    ...
    protected void onSendInvoiceChecked(Object src, EventArgs args) {
        foreach (RepeaterItem item1 in repMainDisplay.Items) {
            ...
            if (checkbox1.Checked) {
                ...
                // Processes the email sender list to remove the , at the end of the last address (to avoid crash)
                processedInvoiceAddresses = invoiceAddresses.Substring(0, invoiceAddresses.Length - 1);
                lblInvoiceList.Text = processedInvoiceAddresses;
            }
        }
    }
    ...
    protected void onSendMessageChecked(Object src, EventArgs args) {
        foreach (RepeaterItem item2 in repMainDisplay.Items) {
            ...
            if (checkbox2.Checked) {
                ...
                processedMessageAddresses = messageAddresses.Substring(0, messageAddresses.Length - 1);
                lblMessageList.Text = processedMessageAddresses;
            }
        }
    }
    ...
    //   message = "This is an automated message from the Rotary Club of Truro Yearbook to inform you that your ad request has been approved. A further email containing an invoice should follow shortly";
    // Then send the email
    //MailMessage o = new MailMessage("From", "To","Subject", "Body");
    //  MailMessage o = new MailMessage("rotariansample@hotmail.com", email,"Rotary Club of Truro Yearbook - Your ad has been approved", message);
    ...
    protected void sendAutomatedMessage(Object src, EventArgs args) {
        ...
        //MailMessage o = new MailMessage("From", "To","Subject", "Body");
        MailMessage o = new MailMessage("rotariansample@hotmail.com", lblMessageList.Text,"Automated Message from the Rotary Club of Truro", message);
        //NetworkCredential netCred= new NetworkCredential("Sender Email","Sender Password");
        NetworkCredential netCred= new NetworkCredential("rotariansample@hotmail.com","It$tudents");
        SmtpClient smtpobj= new SmtpClient("smtp.live.com", 587);
        smtpobj.EnableSsl = true;
        ...
        lblSendFeedback.Text = "Message(s) sent successfully";
    }
    ...
    protected void sendInvoice(Object src, EventArgs args) {
        ...
        //string email = invoiceAddresses;
        string sendemail = processedInvoiceAddresses;
        ...
        lblSendFeedback.Text = "Invoice(s) sent successfully";
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyBox" Runat="Server">
    <form runat="server">
        ...
        <div class="container">
            ...
            <div class="row well col-sm-6">
                <asp:Label ID="lblInvoiceEmailsTitle" Text="These are the emails selected to receive an invoice:" runat="server" /><br />
                <asp:Label ID="lblInvoiceList" Text="" runat="server" />
            </div>
            <div class="row well col-sm-6">
                <asp:Label ID="lblMessageEmailsTitle" Text="These are the emails selected to receive a message:" runat="server" /><br />
                <asp:Label ID="lblMessageList" Text="" runat="server" />
            </div>
            ...
            <div class="row well col-sm-12" style="text-align:center;"> <!-- Secondary Data Display -->
                   ...
                   <div class="row well col-sm-6" style="text-align:center;"> <!-- Secondary Data Display -->
                        ...
                        <asp:Button ID="btnSendMessage" CssClass="btn btn-danger" OnClick="sendAutomatedMessage" Text="Send Message" runat="server" /><br /><br />
                        <asp:Label ID="lblSendFeedback" Text="" runat="server" />
                  </div>
            </div>
