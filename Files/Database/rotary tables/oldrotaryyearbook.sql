...
--
-- Host: localhost
-- Generation Time: Feb 28, 2017 at 10:15 AM
...
CREATE TABLE `sponsor` (
  ...
  `captionName` text NOT NULL,
  `captionAddress` text NOT NULL,
  `captionPhone` varchar(15) NOT NULL,
  `captionEmail` varchar(100) NOT NULL,
  `captionFront` text NOT NULL,
  `captionMiddle` text NOT NULL,
  `captionBack` text NOT NULL,
  `image` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
